...
/**
 * Created by usuario on 06/03/2016.
 */
public class InsertarActivity extends Activity  implements Resultado {
    private final static String TAG = "InsertarActivity";
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        guardar.setOnClickListener(new View.OnClickListener() {
            ...
            al servidor.
             */
                FrasesCelebresTask task = new FrasesCelebresTask(InsertarActivity.this, prefs);
